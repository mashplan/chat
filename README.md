...
This app is deployed to Scaleway Serverless Containers. See `docs/deploy-scaleway.md` for the full guide, including environment variables, secrets, and troubleshooting.
